# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-01 17:33
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact', models.CharField(help_text='Should contain10 digits', max_length=10)),
        ...
        migrations.AddField(
            model_name='jobs',
            name='company',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='company', to='restapp.Recruiter'),
        ),
        migrations.AddField(
            model_name='candidate',
            name='apply_for',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='apply_for', to='restapp.Jobs'),
        ),
        migrations.AddField(
            model_name='candidate',
            name='recruiter',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recruiting', to='restapp.Recruiter'),
        ),
    ]
